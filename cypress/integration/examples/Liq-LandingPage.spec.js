...
// Test case 02 - Assert elements in the Liquibase error page
it ('Assert elements in the Liquibase error page', function()

{

    //Asserting the URL of the current page
    cy.url().should('include', 'amazoncognito.com/error')
    //Asserting the Liguibase lable(Signin)
    cy.title().should('eq','Signin')
